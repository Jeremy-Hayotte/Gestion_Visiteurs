...
class getSecurity_Command_DebugFirewallService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['security.command.debug_firewall'] = $instance = new \Symfony\Bundle\SecurityBundle\Command\DebugFirewallCommand($container->parameters['security.firewalls'], ($container->privates['.service_locator.L1xI0ld'] ?? $container->get_ServiceLocator_L1xI0ldService()), ($container->privates['.service_locator.83WdXXy'] ?? $container->load('get_ServiceLocator_83WdXXyService')), ['auth' => [0 => ($container->privates['security.authenticator.json_login.auth'] ?? $container->load('getSecurity_Authenticator_JsonLogin_AuthService'))], 'api' => [0 => ($container->privates['security.authenticator.jwt.api'] ?? $container->load('getSecurity_Authenticator_Jwt_ApiService'))]], false);
