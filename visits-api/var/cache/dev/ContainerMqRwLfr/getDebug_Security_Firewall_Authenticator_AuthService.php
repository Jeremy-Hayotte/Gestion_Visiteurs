 ...
 */
class getDebug_Security_Firewall_Authenticator_AuthService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'debug.security.firewall.authenticator.auth' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a = ($container->privates['security.authenticator.json_login.auth'] ?? $container->load('getSecurity_Authenticator_JsonLogin_AuthService'));

        if (isset($container->privates['debug.security.firewall.authenticator.auth'])) {
            return $container->privates['debug.security.firewall.authenticator.auth'];
        }

        return $container->privates['debug.security.firewall.authenticator.auth'] = new \Symfony\Component\Security\Http\Authenticator\Debug\TraceableAuthenticatorManagerListener(new \Symfony\Component\Security\Http\Firewall\AuthenticatorManagerListener(new \Symfony\Component\Security\Http\Authentication\AuthenticatorManager([0 => $a], ($container->privates['security.token_storage'] ?? $container->getSecurity_TokenStorageService()), ($container->privates['security.event_dispatcher.auth'] ?? $container->load('getSecurity_EventDispatcher_AuthService')), 'auth', ($container->privates['logger'] ?? $container->getLoggerService()), true, true, [])));
    }
}
